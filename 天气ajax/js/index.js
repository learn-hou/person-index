        ...
        reall.forEach((v)=>{
         // console.log(v);
             ...
             <li>
                ...
                <div class="second" style="background-image:url(img/img/${v.weather_icon_id}.png)"></div>
        ...
        data.forEach((v,i)=>{
           // console.log(v);
            let str=`
                ...
                <div class="box4" style="background-image:url(img/img/${v.weather_icon_id}.png )"></div>
            </li>`;
